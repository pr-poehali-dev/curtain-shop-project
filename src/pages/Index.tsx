...
const Index = () => {
  ...
  const categoryCovers: Array<{
    ...
    {
      category: 'Шторы для спальной',
      image: 'https://cdn.poehali.dev/files/IMG_7876.jpeg',
      title: 'Шторы для спальной'
    },
    {
  ...
  const portfolio: Array<{
    ...
    {
      image: 'https://cdn.poehali.dev/files/IMG_7876.jpeg',
      title: 'Плотные шторы для спальни',
      description: 'Элегантные плотные шторы синего цвета с тюлем — идеальное решение для спальни. Обеспечивают полное затемнение и создают уютную атмосферу.',
      category: 'Шторы для спальной'
    }
  ];
