...
const Index = () => {
  ...
  const portfolio: Array<{
    ...
    },
    {
      ...
      title: 'Электрокарнизы с декоративной окантовкой',
      description: 'Элегантные электрокарнизы с изысканной серебристой декоративной окантовкой и орнаментом — сочетание передовых технологий и классического дизайна',
      category: 'Электрокарнизы'
    },
    {
      ...
      title: 'Электрокарнизы для арочных окон',
