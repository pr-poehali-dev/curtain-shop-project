...
const Index = () => {
  ...
  const portfolio: Array<{
    ...
    },
    {
      ...
      description: 'Автоматические электрокарнизы с тюлем и портьерами коричневого цвета для высоких арочных окон — идеальное решение для панорамного остекления',
      category: 'Электрокарнизы'
    },
    {
      image: 'https://cdn.poehali.dev/files/IMG_7697.jpeg',
